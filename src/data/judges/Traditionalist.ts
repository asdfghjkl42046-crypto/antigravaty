...
export const TRADITIONALIST_JUDGMENT: JudgmentTemplate = {
  win: [
    `本庭看過你的說詞了，法條上確實有你鑽的空間，老夫不否認。\n你的主張是：「{sTerm}」\n勉強說得過去。但你知道老夫這四十年看過多少人用同樣的縫隙爬出去，最後又從哪裡掉回來嗎？撤訴。好好想清楚。`,
    `老夫不是被你說服，是證據不夠讓老夫定你的罪。\n你的說法：「{sTerm}」\n本庭勉強接受。你先走——但你那個表情收一收，這不叫贏，叫暫時沒輸。`,
    `本庭勉強接受你的主張：「{escape}」\n你的黑材料老夫都看過了，這次放你走，不代表老夫沒記著。退庭。`,
  ],
  lose: [
    `老夫年輕的時候也聽過這種說法，那個人後來在監獄裡待了七年。\n你說是：「{sTerm}」\n但你做的是：「{hIntent}」\n這個老夫比你清楚。判決有罪。`,
    `老夫審案四十年，跟老夫說過同樣說法的人，老夫已經數不清了。\n說法：「{sTerm}」\n事實：「{hIntent}」\n每一個說這句話的人，最後都沒能把罪名從判決書上拿掉。你也一樣。`,
    `你以為換個名字，事情的性質就變了嗎？\n你說是：「{sTerm}」\n老夫看到的是：「{hIntent}」\n老夫見過太多聰明人，聰明到覺得規矩是給別人設的。判你有罪——這不是懲罰，是遲早的事。`,
  ],
  silence: [
