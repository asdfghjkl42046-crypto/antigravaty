...
export const ROLE_DATA: {
...
}[] = [
  {
    ...
    levels: [
      ...
      {
        type: '被動',
        desc: '讀穿把戲：答辯時一眼識破破綻，自動剔除 1 個錯誤選項；同時掌握法庭勝率情報',
      },
      {
        type: '主動',
        desc: '隻手遮天：就算答辯失敗也不怕——砸下總資產 20%（至少 100 萬）+ 5 IP，讓對方乖乖撤案',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    color: 'emerald',
    levels: [
      { type: '被動', desc: '稅務優化：商業類（A/D 類）卡片的資金收益，每一份都再多賺 10%' },
      { type: '被動', desc: '罰單打折：法院開出的罰單不用全買單，敗訴罰金直接砍半' },
      { type: 'Streak', desc: '合法避稅：連續 2 回合保持清白後，悄悄將 10% 資金轉入海外信託' },
    ],
  },
  {
    key: 'cto',
    ...
    color: 'blue',
    levels: [
      { type: '被動', desc: '算力套利：每次打出商業投資（A 大類）卡，有 30% 機會讓 AP 神奇歸還' },
      { type: '被動', desc: '駭客腳本：系統每回合自動替你洗出 +100 萬 G 的隱密黑金，悄悄入帳' },
      {
        type: '被動',
        desc: '反間防火牆：對手動用人才市場（B 類）卡時，場上每多一位持有此技能的玩家，產生的犯罪標籤及黑料就多疊一倍',
      },
    ],
  },
];
