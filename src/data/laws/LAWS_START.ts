...
export const LAWS_START: Record<string, LawCase> = {
  'START-01': {
    ...
    defense_j: '那份用戶數據是我們內部系統跑出來的，我沒有叫任何人去改那個數字，我當時看到的就是那個結果。',
    defense_k: '那幾家企業確實有跟我們接觸過，說意向書是虛構的不公平，只是合作最後沒有走到簽約那一步。',
  ...
  'START-02': {
    ...
    defense_j: '公司是我們家族三代建起來的，帳務一直都是老會計師在管，我沒有叫他做兩套帳，那是他自己的作業習慣。',
