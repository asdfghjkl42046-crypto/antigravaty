...
export const LAWS_E: Record<string, LawCase> = {
  ...
  'E-01-1': {
    ...
    defense_j: '硬碟的處理是資訊部門提出來的，說是例行的設備汰換，我沒有想到這個時間點做這件事會有問題。',
    defense_k: '公司定期處理舊設備是正常的資安程序，我當時認為這只是一個硬體維護的決定，不是要銷毀任何調查相關的東西。',
  ...
  'E-02-1': {
    ...
    defense_j: '我請事務所去跟他談是因為我覺得當初 he 離職的條件有些地方可以重新確認，不是要他去說謊。',
    defense_k: '那筆補償是基於他對公司過去的貢獻，附帶的條件我的理解是希望他說出他真實記得的事，不是叫他作偽證。',
  ...
  'E-02-3': {
    ...
    defense_j: '律師的策略是法律團隊自己決定的，我授權他們盡力保護公司，但具體的訴訟手段我沒有逐一指示。',
    defense_k: '那個海外出差的安排是業務部門的正常需求，時間點的問題我沒有想那麼多，不是刻意用來拖延出庭的。',
  ...
  'E-03-2': {
    ...
    defense_k: '系統紀錄的定期清理是技術部門的正常作業，我當時認為那些Log已經超過保存必要，是可以刪除的。',
  ...
  'E-04-1': {
    ...
    defense_j: '找公證人的事是法務部門去處理的，我只是說需要一份文件來補充當時的合作紀錄，細節我沒有全部掌握。',
    defense_k: '我當時的理解是那份文件是在還原一個真實存在的合作意向，不是要捏造一個從來沒有發生過的事。',
  ...
  'E-05-2': {
    ...
    defense_j: '那個架構是財務顧問提出來的，他說這是合法的海外資產配置方式，我當時沒有理由不相信他的專業判斷。',
    defense_k: '那些公司都是在當地合法登記的，資金的流動也是依照各國的法規處理的，我當時認為這是一個合規的安排。',
  ...
  'E-06-3': {
    ...
    defense_j: '郵件系統的清理是資訊長提出的例行維護作業，我知道有這件事，但沒有針對哪一封信下達特別的指示。',
    defense_k: '備份檔案的定期清除在公司的資料管理政策裡是有規定的，我當時認為這是正常的系統維護程序。',
