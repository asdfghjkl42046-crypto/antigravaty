...
export const CARDS_D: Record<string, Card> = {
  'D-01': {
    ...
    3: {
      type: 'Y',
      label: '調查過程中發現對手的實績證明是偽造的，直接向主管機關舉報，讓評審自己去查。',
      rp: 8,
      special: 'skip_next',
    },
  },
  'D-02': {
    ...
    3: {
      type: 'X',
      label:
        '引進最新低碳工法投標——成本高一點、獲利少一點，但在能源轉型的風口上，這個亮點可能比價格更有說服力。',
      succRate: 0.9,
      succ: { g: 100, rp: 2 },
      fail: {},
    },
  ...
  'D-04': {
    title: '偏鄉醫療專案，但裡面有鬼',
    description:
      '這個政府醫療專案獲利不高，但得標之後品牌形象會大幅提升。你在準備投標的過程中，發現一些不太對勁的東西——對手的技術文件有造假嫌疑，而且標案規格感覺是針對特定廠商量身設計的。你手上有料，問題是要怎麼用。',
    1: {
      type: 'Y',
      label:
  ...
  'D-05': {
    ...
    3: {
      type: 'Y',
      label:
        '你聽說對手要用海外公司的牌照來參標——這種敏感標案不允許這樣操作，你直接檢附證據去國安單位按門鈴。對手出局，你什麼都沒做，但什麼都得到了。',
      rp: 8,
      special: 'skip_next',
    },
  },
  'D-06': {
    ...
    2: {
      type: 'X',
      label: '預算就是預算，工法調整一下——照規矩做，把能省的成本省出來，讓數字說話。',
      succRate: 0.9,
      succ: { g: 100, rp: 2 },
      fail: {},
    },
    3: {
      type: 'X',
      label: '主動撥 10% 預算做公共藝術和綠化——超出規格要求，但這種細節最容易在評審心裡留下印象。',
      succRate: 0.9,
      succ: { g: 100, rp: 2 },
      fail: {},
    },
