...
export const CARDS_C: Record<string, Card> = {
  'C-01': {
    ...
    2: {
      type: 'A',
      label: '捐150萬，順便邀媒體來採訪，黃金時段播出企業關懷弱勢的專題——好事做了，順便讓品牌也漂亮一下。',
      succRate: 0.9,
      costG: 150,
      succ: { rp: 5 },
      fail: { loss: 150 },
    ...
    3: {
      type: 'C',
      label: '對外宣布捐400萬，實際上跟仲介串通好，大部分的錢繞一圈再回到公司的不記名帳戶——名聲賺到了，錢也沒真的出去。',
      costG: 400,
      rp: 12,
  ...
  'C-02': {
    ...
    1: {
      type: 'A',
      label: '砸150萬更新設備，把流程真的改到符合標準，然後正式申請認證——貴，但標章貼上去之後睡得著覺。',
      succRate: 0.9,
      costG: 150,
      succ: { rp: 5 },
      fail: { loss: 150 },
    ...
    2: {
      type: 'C',
      label: '花400萬請頂級公關公司做視覺包裝，把污染細節埋在漂亮的數據圖表裡——消費者看的是故事，不是原始數據。',
      costG: 400,
      rp: 12,
      special: 'declareLogic',
      succRate: 0.8,
  ...
  'C-03': {
    ...
    2: {
      type: 'C',
      label: '找幾個人頭帳戶把400萬拆成一堆小額捐款打過去，規避上限、不留痕跡——政治關係做深，但帳面上看不出來是你。',
      costG: 400,
      rp: 12,
      special: 'declareLogic',
      succRate: 0.8,
    ...
    3: {
      type: 'A',
      label: '捐50萬買他的公益慈善餐會入場券——算是表示支持，但跟核心政治獻金保持距離，進退都有空間。',
      succRate: 0.9,
      costG: 50,
      succ: { rp: 2 },
      fail: { loss: 50 },
  ...
  'C-04': {
    ...
    1: {
      type: 'C',
      label: '對外宣布成立400萬教育基金，聽起來很漂亮——但帳目裡有一部分其實是高管的私人交際費，用假報帳藏進去。',
      costG: 400,
      rp: 12,
      special: 'declareLogic',
      succRate: 0.8,
    ...
    3: {
      type: 'A',
      label: '提撥150萬做三年期的師資培訓，邀知名教授當顧問——慢慢來，但這才是真的改變得了什麼的做法。',
      succRate: 0.9,
      costG: 150,
      succ: { rp: 5 },
      fail: { loss: 150 },
  ...
  'C-05': {
    ...
    1: {
      type: 'A',
      label: '投150萬冠名贊助，開幕派對順便邀核心客戶來——藝術展當社交場合用，品牌形象和人脈一起經營。',
      succRate: 0.9,
      costG: 150,
      succ: { rp: 5 },
      fail: { loss: 150 },
    ...
    3: {
      type: 'C',
      label: '用400萬贊助名義買下幾件作品，估價往高開，帳面當投資報帳——順便幫幾個股東把資產低調轉移一下，藝術品本來就很難估價。',
      costG: 400,
      rp: 12,
      special: 'declareLogic',
      succRate: 0.8,
  ...
  'C-06': {
    ...
    1: {
      type: 'C',
      label: '對外宣布設立400萬緊急醫療基金，實際上跟藥商喬好了，捐出去的是過期或劣質物資，帳面價值高估幾倍用來抵稅——反正物資都捐出去了，誰會去驗？',
      costG: 400,
      rp: 12,
      special: 'declareLogic',
      succRate: 0.8,
    ...
    3: {
      type: 'A',
      label: '投150萬資助大學醫學院開發快篩技術，量產後優先供應偏鄉——慢一點，但這筆錢真的會發揮作用。',
      succRate: 0.9,
      costG: 150,
      succ: { rp: 5 },
      fail: { loss: 150 },
  ...
  'C-07': {
    ...
    2: {
      type: 'A',
      label: '撥150萬研發可分解包裝，同時公布詳細的減塑時程表——承認問題、給出計畫，讓外界有東西可以監督。',
      succRate: 0.9,
      costG: 150,
      succ: { rp: 5 },
      fail: { loss: 150 },
    ...
    3: {
      type: 'C',
      label: '花400萬拍一系列美輪美奐的海底生態廣告，宣告公司已達成「塑膠中和」——實際上什麼都沒改，但畫面夠美，夠多人分享就夠了。',
      costG: 400,
      rp: 12,
      special: 'declareLogic',
      succRate: 0.8,
  ...
  'C-08': {
    ...
    2: {
      type: 'C',
      label: '捐400萬給聯賽委員會，但私下談好，部分款項要用「顧問費」名義轉給幾個有用的政界人士——體育贊助是檯面上的，政治關係是檯面下的。',
      costG: 400,
      rp: 12,
      special: 'declareLogic',
      succRate: 0.8,
