...
export const CARDS_A: Record<string, Card> = {
  ...
  'A-02': {
    ...
    3: {
      type: 'B',
      label:
        '設計本來就會互相參考，我們只是「致敬」對方的視覺語言，順便吸引一些對這風格有興趣的客群。',
      g: 180,
      rp: -5,
      bm: 1,
      tags: ['商標權侵權', '虛偽不實廣告'],
  ...
  'A-03': {
    ...
    1: {
      type: 'B',
      label:
        '就是「調整一下認列時間點」而已——把明年幾乎確定會簽的合約，提前算進今年。會計師說這叫「彈性空間」。',
      g: 200,
      rp: -5,
      bm: 1,
      tags: ['商業會計法'],
    ...
    3: {
      type: 'B',
      label:
        '請同事把這個月的發票都丟來，餐費、油錢、咖啡通通報成研發費用。省下來的稅，就當大家的績效獎金。',
      g: 150,
      rp: -5,
      bm: 1,
      tags: ['稅捐稽徵法'],
  ...
  'A-04': {
    ...
    1: {
      type: 'C',
      label:
        '匿名寄一份「檢舉資料」給評審，裡面有幾份看起來很真的侵權證據——雖然是自己做的，但對方又沒辦法馬上澄清。',
      g: 450,
      rp: -15,
      bm: 3,
      tags: ['公平交易法', '誹謗罪'],
    ...
    2: {
      type: 'B',
      label:
        '對方的核心邏輯根本沒保護，拿來參考一下也不算侵權吧？反正他們法務團隊看起來也沒什麼預算來告人。',
      g: 220,
      rp: -5,
      bm: 1,
      tags: ['著作權侵權'],
  ...
  'A-05': {
    ...
    3: {
      type: 'C',
      label:
        '請工程師「優化」一下後台數據的顯示方式，讓報告看起來漂亮一點——反正客戶也不懂怎麼查原始資料。',
      g: 400,
      rp: -15,
      bm: 3,
      tags: ['虛偽不實廣告', '商業背信'],
  ...
  'A-07': {
    ...
    3: {
      type: 'C',
      label:
        '叫對方開一張「行銷勞務費」的發票，這樣錢可以正式報帳，還能順便抵稅——合法包裝，兩頭賺。',
      g: 420,
      rp: -15,
      bm: 3,
      tags: ['商業會計法', '稅捐稽徵法'],
  ...
  'A-08': {
    ...
    2: {
      type: 'C',
      label:
        '趁對方還沒拿到控制權，悄悄把核心專利用超低價「賣」給自己在海外開的空殼公司——人家買的到公司，買不到技術。',
      g: 500,
      rp: -15,
      bm: 3,
      tags: ['毀損債權', '商業背信'],
    ...
    3: {
      type: 'B',
      label:
        '在合約裡埋一顆「毒藥丸」——只要有人強行併購，公司就自動觸發一筆巨額債務，讓對方吃下去也消化不良。',
      g: 220,
      rp: -5,
      bm: 1,
      tags: ['公司法'],
  ...
  'A-09': {
    ...
    2: {
      type: 'B',
      label:
        '補償金不給，但在合約裡塞一個天文數字的賠償條款——反正大部分人看到那個數字就嚇跑了，不一定真的要告。',
      g: 150,
      rp: -5,
      bm: 1,
      tags: ['無效競業禁止'],
  ...
  'A-10': {
    ...
    1: {
      type: 'C',
      label:
        '把這筆大錢拆成一堆小錢，分批打進公司比較少用的外幣帳戶——每筆都在申報門檻以下，查核系統很難抓到。',
      g: 480,
      rp: -15,
      bm: 3,
      tags: ['稅捐稽徵法', '洗錢防制法'],
    ...
    3: {
      type: 'B',
      label:
        '買幾個NFT，申報成「數位行銷推廣支出」——帳面獲利降下來，稅少繳，反正NFT本來就很難估價。',
      g: 180,
      rp: -5,
      bm: 1,
      tags: ['虛偽不實廣告', '假帳'],
  ...
  'A-11': {
    ...
    1: {
      type: 'C',
      label:
        '花錢買一批水軍，用「受害消費者」的口吻在各平台瘋狂轉發——反正大家已經在罵了，再加幾把火而已。',
      g: 420,
      rp: -15,
      bm: 3,
      tags: ['公平交易法', '誹謗罪'],
    ...
    2: {
      type: 'B',
      label:
        '推出「安心選擇」廣告，大秀自家的檢驗證書 and 安全認證——沒有直接點名，但懂的人都懂在說誰。',
      g: 200,
      rp: -5,
      bm: 1,
      tags: ['虛偽不實廣告'],
  ...
  'A-12': {
    ...
    2: {
      type: 'B',
      label:
        '叫財務把出貨單的日期「調整」一下，讓開票時間順理成章地落在匯率最好的那天——文件還是文件，只是日期不同。',
      g: 180,
      rp: -5,
      bm: 1,
      tags: ['商業會計法', '偽造文書'],
  ...
  'A-13': {
    ...
    3: {
      type: 'C',
      label:
        '把這批貨捐給公益團體，順便申請一張抵稅證明——金額嘛，就往高一點開，反正是捐出去的東西，誰會去查？',
      g: 450,
      rp: -15,
      bm: 3,
      tags: ['稅捐稽徵法', '洗錢防制法'],
  ...
  'A-14': {
    ...
    3: {
      type: 'C',
      label:
        '找個熟悉的外包商簽一份技術合約，把補助款打過去再扣手續費匯回來——帳面上是研發支出，實際上是自己的錢。',
      g: 500,
      rp: -15,
      bm: 3,
      tags: ['刑法/詐欺取財罪', '洗錢防制法'],
  ...
  'A-15': {
    ...
    2: {
      type: 'B',
      label:
        '不叫「轉讓」，叫「技術諮詢」——把核心拆成幾個模組分批授權出去，合約上看起來就是一般的顧問服務。',
      g: 300,
      rp: -5,
      bm: 1,
      tags: ['營業秘密法', '貿易法'],
  ...
  'A-16': {
    ...
    2: {
      type: 'B',
      label:
        '剪一段展示影片，把還沒做好的功能剪進去——動態跑起來就是跑起來了，客戶現場又不會真的點進去用。',
      g: 180,
      rp: -5,
      bm: 1,
      tags: ['虛偽不實廣告', '商業背信'],
    ...
    3: {
      type: 'B',
      label:
        '叫外包商連夜把另一個客戶的系統改個介面拿來充數——功能邏輯都一樣，換個顏色 and Logo就是「新系統」了。',
      g: 200,
      rp: -5,
      bm: 1,
      tags: ['著作權侵權', '營業秘密法'],
  ...
  'A-17': {
    ...
    2: {
      type: 'B',
      label:
        '暗中金援這些員工去告前東家勞資糾紛——對方忙著應付官司，人心渙散，這時候再出手挖人，事半功倍。',
      g: 200,
      rp: -5,
      bm: 1,
      tags: ['公平交易法', '妨害名譽罪'],
