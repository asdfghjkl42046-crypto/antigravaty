...
import { Player, RoleLevel, RoleMap } from '../types/game';
...
async function runSkillSweep() {
  ...
  const pAcc0 = { ...mockPlayer, roles: { accountant: 0 as RoleLevel }, g: 1000 };
  const pAcc1 = { ...mockPlayer, roles: { accountant: 1 as RoleLevel }, g: 1000 };
  const pAcc2 = { ...mockPlayer, roles: { accountant: 2 as RoleLevel }, g: 1000 };
  const pAcc3 = { ...mockPlayer, roles: { accountant: 3 as RoleLevel }, g: 1000, consecutiveCleanTurns: 2, trustFund: 0 };
  ...
  const pPR0 = { ...mockPlayer, roles: { pr: 0 as RoleLevel } };
  const pPR1 = { ...mockPlayer, roles: { pr: 1 as RoleLevel } };
  const pPR2 = { ...mockPlayer, roles: { pr: 2 as RoleLevel } };
  ...
  const pCTO0 = { ...mockPlayer, roles: { cto: 0 as RoleLevel } };
  const pCTO2 = { ...mockPlayer, roles: { cto: 2 as RoleLevel } };
  ...
  // CTO 標籤倍增測試 (1+N)
  const allPlayers = [
    { ...mockPlayer, id: 'p1', roles: { cto: 3 as RoleLevel } },
    { ...mockPlayer, id: 'p2', roles: { cto: 3 as RoleLevel } },
    { ...mockPlayer, id: 'p3', roles: { cto: 0 as RoleLevel } }
  ] as Player[];
