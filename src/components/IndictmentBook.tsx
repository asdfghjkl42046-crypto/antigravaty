...
/**
 * IndictmentBook V2.0 - 100% 繼承黃金物理引擎 (手感同步 ParchmentBook)
 * 
 * 修改重點：
 * 1. 邏輯完全同步於 ParchmentBook V4.0 (包含 Ref+State 雙軌同步與防穿透)。
 * 2. 視覺風格轉向法律權威感：深藍色調、法槌圖示。
 */
