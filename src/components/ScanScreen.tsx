    ...
    <div className="flex flex-col h-full animate-in fade-in zoom-in-95 duration-500 bg-slate-950 p-4 relative overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-6 relative z-10">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h2 className="text-xl font-black tracking-tighter text-white uppercase italic">數據解碼終端</h2>
            <p className="text-[9px] font-bold text-amber-500/60 tracking-widest uppercase">Encryption Link Established</p>
          </div>
        </div>
        <button 
          onClick={onBack}
        ...
        <div className="w-full max-w-xs space-y-4">
          <div className="bg-slate-900/60 border border-white/10 rounded-3xl p-5 shadow-inner">
            <div className="flex items-center space-x-2 mb-3">
              ...
              <span className="text-[10px] font-black text-blue-400 uppercase tracking-widest">備援編碼輸入</span>
            </div>
